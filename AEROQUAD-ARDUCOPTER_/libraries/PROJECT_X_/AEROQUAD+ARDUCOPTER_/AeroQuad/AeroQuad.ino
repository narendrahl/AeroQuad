...
void process100HzTask() {
  ...
  if ( Calibrated_XY == false )
   {
    S_P_X = kinematicsAngle[XAXIS];
    S_P_Y = kinematicsAngle[YAXIS];
    Calibrated_XY = true ;
   }
...
//Serial2.print("x");
/*
Serial2.print(motorCommand[FRONT]);
Serial2.print(":");
Serial2.print(motorCommand[REAR]);
Serial2.print(":");
Serial2.print(motorCommand[RIGHT]);
Serial2.print(":");
Serial2.print(motorCommand[LEFT]);
Serial2.print(":");
*/
/*  
Serial2.print("x");
...
// #ifdef Leader
//        mavlink_msg_global_position_int_pack(MAV_SYSTEM_ID, MAV_COMPONENT_ID, &msg, millisecondsSinceBoot, gpsData.lat, gpsData.lon, getGpsAltitude() * 10, (getGpsAltitude() - baroGroundAltitude * 100) * 10 , 0, 0, 0, ((int)(trueNorthHeading / M_PI * 180.0) + 360) % 360);
...
//#ifdef Follower
//Serial2.print(readWaypointLF.latitude);
//#endif
...
//  #endif
//    processHeading();  just for test we placed processHeading in 1Hz
//readSerialCommand();
//sendSerialTelemetry();
//Serial2.print('T');
...
/*
    Serial2.print(receiverCommand[AUX1]);
    Serial2.print(":");
    Serial2.print(receiverCommand[AUX2]);
    Serial2.print(":");
    Serial2.print(receiverCommand[MODE]);
    Serial2.print(":");
    Serial2.print(receiverCommand[XAXIS]);
    Serial2.print(":");
    Serial2.print(receiverCommand[YAXIS]);
    Serial2.print(":");
    Serial2.print(receiverCommand[ZAXIS]);
    Serial2.print(":");
    Serial2.print(receiverCommand[THROTTLE]);
    Serial2.print(":");
    Serial2.print(receiverCommand[AUX3]);
    Serial2.print(":");
